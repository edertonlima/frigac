...
<?php get_header(); ?>
	...
	<section class="box-section">
		<div class="container">
			<div class="row">
				<div class="col-12 align-center">
					<ul class="icon-page icon-cor2">
						<li>
							<a href="<?php echo get_home_url(); ?>/?cat=1" title="Receitas">
								<div class="icon-page-imagem">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/images/ico-receitas.png" alt="Receitas">
								</div>
								Receitas
							</a>
						</li>
						<li>
							<a href="<?php echo get_home_url(); ?>/?page_id=54" title="Harmonização">
								<div class="icon-page-imagem">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/images/ico-harmonizacao.png" alt="Harmonização">
								</div>
								Harmonização
							</a>
						</li>
						<li>
							<a href="<?php echo get_home_url(); ?>/?page_id=56" title="Churrasco">
								<div class="icon-page-imagem">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/images/ico-churrasco.png" alt="Churrasco">
								</div>
								Churrasco
							</a>
						</li>
	...
	<section class="box-section box-section-no-padding">
		<div class="slide-page slide-sustentabilidade">
